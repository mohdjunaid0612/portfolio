...
const Footer = () => {
  ...
  return (
    <footer className="footer py-12 bg-zinc-950">
        ...
        <div className="flex items-center justify-between border-b pb-6 border-zinc-800">
          ...
          <div className="flex gap-6">
            <div className="flex items-center">
              <Link
                to="tel:7042860653"
                className="text-xl font-semibold text-white pe-2"
              >
                <i className="fa fa-phone-volume text-2xl text-primary me-3"></i>{" "}
                +91 70428 60653
              </Link>
            </div>
            <div className="flex items-center">
              <Link
                ...
                className="text-xl font-semibold text-white pe-2"
              >
                <i className="fa fa-envelope text-2xl text-primary me-3"></i>{" "}
            ...
            <div className="flex items-center">
              <Link
                ...
                className="text-xl font-semibold text-white pe-2"
              >
                <i className="fa fa-map-marker-alt text-2xl text-primary me-3"></i>{" "}
